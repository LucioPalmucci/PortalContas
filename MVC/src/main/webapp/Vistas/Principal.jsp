...
<c:choose>
    ...
    <c:otherwise>
        ...
        <head>
            ...
            <link rel="icon" type="image/jpeg" href="${pageContext.request.contextPath}/icons/contasPfp.jpg">
            <link rel="manifest" href="${pageContext.request.contextPath}/manifest/manifest.json">
            <link rel="apple-touch-icon" href="${pageContext.request.contextPath}/icons/contasPfp.jpg" >
        </head>
        <body>
