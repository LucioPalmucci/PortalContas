                    ...
                    <table class="table table-hover align-middle mb-0 filas-espaciadas tabla-tarjetas-movil">
                        ...
                        <c:forEach var="gasto" items="${gastos}">
                            <tr data-fila
                                ...
                                <c:if test="${esAdmin}"><td data-label="Cliente" class="col-extra">${gasto.usuario.nombreCompleto}</td></c:if>
                                <td data-label="Fecha"><fmt:formatDate value="${gasto.fecha}" pattern="dd/MM/yyyy"/></td>
                                <td data-label="Categoria" class="fw-semibold">${gasto.categoria.nombre}</td>
                                <td data-label="Monto" class="fw-semibold"><fmt:formatNumber value="${gasto.valor}" type="currency" currencySymbol="$"/></td>
                                <td data-label="Medio" class="col-extra">${gasto.metodo.nombre}</td>
